        ...
        sourceComponent: PanelWindow { // Session menu
            ...
            ColumnLayout { // Content column
                ...
                GridLayout {
                    ...
                    SessionActionButton {
                        id: sessionScreenOff
                        buttonIcon: "desktop_access_disabled"
                        buttonText: Translation.tr("Screen Off")
                        focus: sessionRoot.visible
                        onClicked: {
                            Quickshell.execDetached(["bash", "-c", "sleep 0.5; hyprctl dispatch dpms off"])
                            sessionRoot.hide();
                        }
                    ...
                    SessionActionButton {
                        ...
                        onFocusChanged: { if (focus) sessionRoot.subtitle = buttonText }
                        KeyNavigation.left: sessionScreenOff
                    ...
                    SessionActionButton {
                        ...
                        onFocusChanged: { if (focus) sessionRoot.subtitle = buttonText }
                        KeyNavigation.up: sessionScreenOff
